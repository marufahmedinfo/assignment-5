...
//     const inputquota = getElementById('q-input-donation');
//     if(isNaN !== inputquota && inputquota <= total){
//         const donation = inputquota + giveQuota;
//         document.getElementById('give-quota').innerText = donation;
//         const newbalance = total - donation;
//         document.getElementById('total-balance').innerText = newbalance;
